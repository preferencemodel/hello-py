"""
ML training pipeline for image classification.

This script trains a simple classifier on synthetic image data.
"""
...
def run_training_pipeline():
    ...
    images, labels = generate_synthetic_images(n_samples=1000, img_size=28)
    ...
    print(f"✓ Model evaluation took {step6_time:.2f}s")
